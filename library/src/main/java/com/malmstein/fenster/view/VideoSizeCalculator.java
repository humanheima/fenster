...
public class VideoSizeCalculator {
    ...
    protected Dimens measure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (hasASizeYet()) {
            ...
            if (widthSpecMode == View.MeasureSpec.EXACTLY && heightSpecMode == View.MeasureSpec.EXACTLY) {
                Log.e(TAG, "measure: widthSpecMode  && heightSpecMode == View.MeasureSpec.EXACTLY,width=" + width + ",height=" + height);
                // the size is fixed
                width = widthSpecSize;
                ...
                Log.e(TAG, "measure: widthSpecMode == View.MeasureSpec.EXACTLY");
                ...
                Log.e(TAG, "measure:  heightSpecMode == View.MeasureSpec.EXACTLY");
    ...
    public String currentWidthHeight() {
        return "(mVideoWidth= " + mVideoWidth + "&& mVideoHeight= " + mVideoHeight + ")";
    }
